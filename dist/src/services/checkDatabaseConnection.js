...
exports.checkDatabaseStatus = void 0;
var mongoose_1 = __importDefault(require("mongoose"));
var cryptoModel_1 = require("src/models/cryptoModel");
var checkDatabaseStatus = function () { return __awaiter(void 0, void 0, void 0, function () {
    var state, count, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                error_1 = _a.sent();
                console.error("Error checking database status:", error_1);
                return [3 /*break*/, 5];
